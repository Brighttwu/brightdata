        ...
        <div className="min-height-[calc(100vh-80px)] flex items-center justify-center p-6 mt-10">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400">Sign in to manage your data business</p>
                </div>
                ...
                <p className="text-center mt-6 text-slate-400 text-sm">
                    Don't have an account? <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-medium no-underline">Create one</Link>
                </p>
            </motion.div>
        </div>
    );
