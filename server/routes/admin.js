    ...
    try {
        ...
        for (const order of pendingOrders) {
            ...
            try {
                ...
                sParams.append('order_id', order.orderId);
                ...
                console.error(`Sync failed for order ${order._id}:`, err.message);
            }
        }
        res.json({ message: `Sync completed. ${updatedCount} orders updated.`, updatedCount });
    } catch (err) {
        console.error(err);
