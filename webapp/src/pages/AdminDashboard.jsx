...
import { Users, ShoppingBag, DollarSign, Wallet, ShieldAlert, Ban, PlusCircle, MinusCircle, Search, Store, ExternalLink, Power, Settings as SettingsIcon, Bell, Truck, Save, Smartphone, RefreshCw, Sparkles } from 'lucide-react';
                    ...
                    <>
                        ...
                        <div className="admin-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
                            ...
                            <div style={cardStyle}>
                                ...
                                <div style={{ fontSize: 13, fontWeight: 700, color: '#94a3b8', marginTop: 12 }}>Gross Agent Profit (Life-Time)</div>
                                <div style={{ fontSize: 28, fontWeight: 900, color: '#f59e0b' }}>₵{(stats.agentProfitLifetime || 0).toFixed(2)}</div>
                                <div style={{ fontSize: 11, color: '#64748b', marginTop: 4 }}>Total earnings (withdrawals included)</div>
                            </div>
